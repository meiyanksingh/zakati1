...
package com.mks.zakati.views.rangeSeekbar;
...
public class RangeSeekBar<T extends Number> extends AppCompatImageView {
    ...
    private Boolean extraTextAvailable;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int thumbNormal = R.drawable.seekbar_drawable;
        int thumbPressed = R.drawable.seekbar_drawable;
        int thumbDisabled = R.drawable.seekbar_drawable;
        ...
        if (attrs == null) {
            ...
            try {
                ...
                //Extra text Settings
                extraTextAvailable = a.getBoolean(R.styleable.RangeSeekBar_extraTextAvailable, false);
                extraText = a.getString(R.styleable.RangeSeekBar_extraText);
            } finally {
                a.recycle();
            }
        }
    ...
    protected synchronized void onDraw(@NonNull Canvas canvas) {
        ...
        //paint.setTypeface(ZakitiApplication.getFrankf());
        ...
        if (showTextAboveThumbs && (activateOnDefaultValues || !selectedValuesAreDefault)) {
            ...
            if (extraTextAvailable){
                minText = valueToString(getSelectedMinValue()) + " " + extraText;
                maxText = valueToString(getSelectedMaxValue()) + " " + extraText;
            }
            else {
