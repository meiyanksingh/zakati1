 ...
 */
public class StrokeCirculerImageView extends android.support.v7.widget.AppCompatImageView {

    public StrokeCirculerImageView(Context context) {
        super(context);
    }

    public StrokeCirculerImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public StrokeCirculerImageView(Context context, AttributeSet attrs, int defStyle) {
